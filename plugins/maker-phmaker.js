...
if (!mime) throw '*[❗] 𝚁𝚎𝚙𝚕𝚢/𝚝𝚊𝚐 𝚊 𝚙𝚒𝚌𝚝𝚞𝚛𝚎*'
if (!/image\/(jpe?g|png)/.test(mime)) throw `*[❗] 𝚃𝚑𝚎 𝚏𝚒𝚕𝚎 𝚝𝚢𝚙𝚎 ${mime} 𝙸𝚝 𝚒𝚜 𝚗𝚘𝚝 𝚌𝚘𝚛𝚛𝚎𝚌𝚝, 𝚛𝚎𝚖𝚎𝚖𝚋𝚎𝚛 𝚝𝚑𝚊𝚝 𝚒𝚝 𝚖𝚞𝚜𝚝 𝚋𝚎 𝚊𝚗 𝚒𝚖𝚊𝚐𝚎, 𝚓𝚙𝚐, 𝚓𝚙𝚎𝚐 𝚘𝚛 𝚙𝚗𝚐*`
...
m.reply('*[❗] 𝚖𝚊𝚔𝚒𝚗𝚐 𝚍𝚎𝚜𝚒𝚐𝚗, 𝚠𝚊𝚒𝚝 𝚊 𝚖𝚘𝚖𝚎𝚗𝚝...*')
let img = await q.download?.()
let url = await uploadImage(img)
let images = `https://violetics.pw/api/photomaker/${encodeURIComponent(text)}?apikey=0291-2c9b-ad7c&image=${encodeURIComponent(url)}`
let caption = `*⎔┉━「 𝐏𝐇𝐌𝐀𝐊𝐄𝐑 」━┉⎔*
*💟 𝙴𝙵𝙵𝙴𝙲𝚃:* ${text}`
conn.sendButton(m.chat, caption, wm, images, [['💫𝚖𝚘𝚛𝚎 𝚘𝚙𝚝𝚒𝚘𝚗𝚜 💫', `${usedPrefix}phmakerlist`]], m)
}
