...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*[❗𝐈𝐍𝐅𝐎❗] 𝐓𝐡𝐞 +𝟏𝟖 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬 𝐚𝐫𝐞 𝐝𝐢𝐬𝐚𝐛𝐥𝐞𝐝 𝐢𝐧 𝐭𝐡𝐢𝐬 𝐠𝐫𝐨𝐮𝐩, 𝐢𝐟 𝐲𝐨𝐮 𝐚𝐫𝐞 𝐚𝐝𝐦𝐢𝐧 𝐚𝐧𝐝 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐞𝐧𝐚𝐛𝐥𝐞 𝐭𝐡𝐞𝐦 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 #𝐞𝐧𝐚𝐛𝐥𝐞 𝐦𝐨𝐝𝐨𝐡𝐨𝐫𝐧𝐲*ny*'
