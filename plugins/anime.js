...
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 𝙵𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 🔄', `/${command}`]], m)}
if (command == 'akiyama') {
let haha = await conn.getFile(`https://api-reysekha.herokuapp.com/api/wallpaper/akiyama?apikey=APIKEY`)
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 𝙵𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 🔄', `/${command}`]], m)}
if (command == 'anna') {
let haha = await conn.getFile(`https://api.zeeoneofc.xyz/api/anime/anna?apikey=kUF2aBjM`)
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 𝙵𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 🔄', `/${command}`]], m)}
if (command == 'asuna') {
