...
if (!effect) throw '*[❗𝐈𝐍𝐅𝐎❗] 𝙷𝚘𝚠 𝚝𝚘 𝚞𝚜𝚎 𝚝𝚑𝚒𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍?*\n—◉ _#logo (efecto) (texto)_\n*𝙴𝚡𝚊𝚖𝚙𝚕𝚎:*\n—◉ _#logo 3d-deep-sea-metal ibrahim_\n\n*[❗] 𝚆𝚑𝚎𝚗 𝙸 𝚝𝚎𝚕𝚕 𝚝𝚑𝚎𝚖 𝚝𝚑𝚊𝚝 𝚊 𝚝𝚎𝚡𝚝 𝚒𝚜 𝚗𝚎𝚎𝚍𝚎𝚍, 𝚝𝚑𝚎 𝚞𝚜𝚎 𝚠𝚘𝚞𝚕𝚍 𝚋𝚎:*\n—◉ _#logo (efecto) (texto1|texto2)_\n*𝙴𝚡𝚊𝚖𝚙𝚕𝚎:*\n—◉ _#logo Wolf-Logo-Galaxy ibrahim|khan_\n\n*<𝙴𝚏𝚏𝚎𝚌𝚝 𝙻𝚒𝚜𝚝/>*\n\n° ඬ⃟📝 #logo ' + effects.map(v => v.title).join('\n° ඬ⃟📝 #logo ')
effect = effect.toLowerCase()
if (!effects.find(v => (new RegExp(v.title, 'gi')).test(effect))) throw `*[❗𝐈𝐍𝐅𝐎❗] 𝚃𝚑𝚎 𝚎𝚏𝚏𝚎𝚌𝚝 ${effect} 𝙸𝚝 𝚒𝚜 𝚗𝚘𝚝 𝚒𝚗 𝚝𝚑𝚎 𝚕𝚒𝚜𝚝 𝚘𝚏 𝚎𝚏𝚏𝚎𝚌𝚝𝚜*`
let text = txt.replace(new RegExp(effect, 'gi'), '').trimStart()
if (text.includes(split)) text = text.split(split)
text = Array.isArray(text) ? text : [text]
let res = await textpro(effect, ...text)
if (typeof res == 'number') throw res == -1 ? `*[❗𝐈𝐍𝐅𝐎❗] 𝚃𝚑𝚎 𝚎𝚏𝚏𝚎𝚌𝚝 ${effect} 𝙸𝚝 𝚒𝚜 𝚗𝚘𝚝 𝚒𝚗 𝚝𝚑𝚎 𝚕𝚒𝚜𝚝 𝚘𝚏 𝚎𝚏𝚏𝚎𝚌𝚝𝚜*` : `*[❗𝐈𝐍𝐅𝐎❗] 𝚃𝚑𝚎 𝚌𝚘𝚛𝚛𝚎𝚌𝚝 𝚞𝚜𝚎 𝚘𝚏 𝚝𝚑𝚎 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚒𝚜 ${usedPrefix + command} ${effect} ${new Array(res).fill('texto').map((v, i) => v + (i ? i + 1 : '')).join('|')}*`
let result = await axios.get(res, {
responseType: 'arraybuffer'
})
await conn.sendFile(m.chat, result.data, 'Error.jpg', `*𝚃𝚊𝚔𝚎 𝚢𝚘𝚞𝚛 𝚌𝚞𝚜𝚝𝚘𝚖 𝚒𝚖𝚊𝚐𝚎!!*\n*𝙴𝚏𝚏𝚎𝚌𝚝: ${effect}*`, m)
}
handler.help = ['logos']
handler.tags = ['nulis']
